    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-12">
      ...
      >
        <div className="text-center mb-6">
          ...
          <div className="text-white/60 text-sm mt-1">Create your account</div>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <label className="block">
            ...
            <input
              ...
              className="mt-1 w-full bg-bg-base/80 border border-white/10 rounded-btn px-3 py-2.5 focus:outline-none focus:border-accent"
            />
          </label>
          <label className="block">
